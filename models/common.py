...
class CBAM(nn.Module):
    def __init__(self, c1,reduction=16,kernel_size=49):
        super(CBAM, self).__init__()
        self.ca=CAM(c1=c1,reduction=reduction)
        self.sa=SAM(kernel_size=kernel_size)
