        ...
        if len(data_dict) > 0:
            ...
            class CustomCOCOeval(COCOeval):
                def __init__(self, cocoGt=None, cocoDt=None, iouType='segm'):
                    ...
                    self.params.maxDets = [1000, 5000, 10000]
                    self.params.iouThrs = np.array([ 0.65 ,  0.65,  0.65 , 0.65,  0.65 ,  0.65,  0.65 ,  0.65,  0.65 ,  0.65])
                    # self.params.iouThrs = np.array([ 0.50 ,  0.50,  0.50 , 0.50,  0.50 ,  0.50,  0.50 ,  0.50,  0.50 ,  0.50])
